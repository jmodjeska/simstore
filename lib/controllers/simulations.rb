...
include Contract
  ...
  def add_stock
    ...
    @unique_items.times do
      amount = rand( 10..@max_stock_per_item )
  ...
  def populate_transactions
    random_sales = rand( 50..@max_daily_transactions )
  ...
  def assign_promotions_to_products
    # Hard-coded to apply promos to first 1/3 of products
    # for demonstration purposes
    id = 1
    ( @unique_items / 3 ).times do
  ...
  def make_sale(pid = false)
    ...
    discount, promo_id = apply_promotions(product, qty)
